...
if("TRUE" STREQUAL "TRUE")
  set(controller_manager_SOURCE_PREFIX /home/weety/tart5/src/roscontrol/src/ros_control/controller_manager)
  set(controller_manager_DEVEL_PREFIX /home/weety/tart5/devel/.private/controller_manager)
  ...
  set(controller_manager_INSTALL_PREFIX /home/weety/tart5/install)
...
if(NOT "/home/weety/tart5/src/roscontrol/src/ros_control/controller_manager/include;/home/weety/boost_1_61_0 " STREQUAL " ")
  set(controller_manager_INCLUDE_DIRS "")
  set(_include_dirs "/home/weety/tart5/src/roscontrol/src/ros_control/controller_manager/include;/home/weety/boost_1_61_0")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'controller_manager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/weety/tart5/src/roscontrol/src/ros_control/controller_manager/${idir}'.  Ask the maintainer 'Adolfo Rodriguez Tsouroukdissian <adolfo.rodriguez@pal-robotics.com>, Bence Magyar <bence.magyar.robotics@gmail.com>, Enrique Fernandez <enrique.fernandez.perdomo@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/weety/tart5/devel/.private/controller_manager/lib;/home/weety/tart5/devel/lib;/opt/ros/kinetic/lib)
