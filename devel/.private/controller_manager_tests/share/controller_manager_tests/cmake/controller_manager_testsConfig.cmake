...
if("TRUE" STREQUAL "TRUE")
  set(controller_manager_tests_SOURCE_PREFIX /home/weety/tart5/src/roscontrol/src/ros_control/controller_manager_tests)
  set(controller_manager_tests_DEVEL_PREFIX /home/weety/tart5/devel/.private/controller_manager_tests)
  ...
  set(controller_manager_tests_INSTALL_PREFIX /home/weety/tart5/install)
...
if(NOT "/home/weety/tart5/src/roscontrol/src/ros_control/controller_manager_tests/include " STREQUAL " ")
  set(controller_manager_tests_INCLUDE_DIRS "")
  set(_include_dirs "/home/weety/tart5/src/roscontrol/src/ros_control/controller_manager_tests/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'controller_manager_tests' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/weety/tart5/src/roscontrol/src/ros_control/controller_manager_tests/${idir}'.  Ask the maintainer 'Adolfo Rodriguez Tsouroukdissian <adolfo.rodriguez@pal-robotics.com>, Bence Magyar <bence.magyar.robotics@gmail.com>, Enrique Fernandez <enrique.fernandez.perdomo@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/weety/tart5/devel/.private/controller_manager_tests/lib;/home/weety/tart5/devel/lib;/opt/ros/kinetic/lib)
