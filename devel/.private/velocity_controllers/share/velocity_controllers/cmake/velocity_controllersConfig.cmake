...
if("TRUE" STREQUAL "TRUE")
  set(velocity_controllers_SOURCE_PREFIX /home/weety/tart5/src/roscontrol/src/ros_controllers/velocity_controllers)
  set(velocity_controllers_DEVEL_PREFIX /home/weety/tart5/devel/.private/velocity_controllers)
  ...
  set(velocity_controllers_INSTALL_PREFIX /home/weety/tart5/install)
...
if(NOT "/home/weety/tart5/src/roscontrol/src/ros_controllers/velocity_controllers/include " STREQUAL " ")
  set(velocity_controllers_INCLUDE_DIRS "")
  set(_include_dirs "/home/weety/tart5/src/roscontrol/src/ros_controllers/velocity_controllers/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'velocity_controllers' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Adolfo Rodriguez Tsouroukdissian <adolfo.rodriguez@pal-robotics.com>, Bence Magyar <bence.magyar.robotics@gmail.com>, Enrique Fernandez <enrique.fernandez.perdomo@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'velocity_controllers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/weety/tart5/src/roscontrol/src/ros_controllers/velocity_controllers/${idir}'.  Ask the maintainer 'Adolfo Rodriguez Tsouroukdissian <adolfo.rodriguez@pal-robotics.com>, Bence Magyar <bence.magyar.robotics@gmail.com>, Enrique Fernandez <enrique.fernandez.perdomo@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/weety/tart5/devel/.private/velocity_controllers/lib;/home/weety/tart5/devel/lib;/opt/ros/kinetic/lib)
