...
if("TRUE" STREQUAL "TRUE")
  set(diff_drive_controller_SOURCE_PREFIX /home/weety/tart5/src/roscontrol/src/ros_controllers/diff_drive_controller)
  set(diff_drive_controller_DEVEL_PREFIX /home/weety/tart5/devel/.private/diff_drive_controller)
  ...
  set(diff_drive_controller_INSTALL_PREFIX /home/weety/tart5/install)
...
if(NOT "/home/weety/tart5/src/roscontrol/src/ros_controllers/diff_drive_controller/include " STREQUAL " ")
  set(diff_drive_controller_INCLUDE_DIRS "")
  set(_include_dirs "/home/weety/tart5/src/roscontrol/src/ros_controllers/diff_drive_controller/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'diff_drive_controller' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Bence Magyar <bence.magyar.robotics@gmail.com>, Enrique Fernandez <enrique.fernandez.perdomo@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'diff_drive_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/weety/tart5/src/roscontrol/src/ros_controllers/diff_drive_controller/${idir}'.  Ask the maintainer 'Bence Magyar <bence.magyar.robotics@gmail.com>, Enrique Fernandez <enrique.fernandez.perdomo@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/weety/tart5/devel/.private/diff_drive_controller/lib;/home/weety/tart5/devel/lib;/opt/ros/kinetic/lib)
