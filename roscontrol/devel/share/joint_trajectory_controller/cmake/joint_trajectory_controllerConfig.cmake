...
if(NOT "/home/weety/roscontrol/src/ros_controllers/joint_trajectory_controller/include " STREQUAL " ")
  set(joint_trajectory_controller_INCLUDE_DIRS "")
  set(_include_dirs "/home/weety/roscontrol/src/ros_controllers/joint_trajectory_controller/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'joint_trajectory_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/weety/roscontrol/src/ros_controllers/joint_trajectory_controller/${idir}'.  Ask the maintainer 'Adolfo Rodriguez Tsouroukdissian <adolfo.rodriguez@pal-robotics.com>, Bence Magyar <bence.magyar.robotics@gmail.com>, Enrique Fernandez <enrique.fernandez.perdomo@gmail.com>' to fix it.")
    endif()
