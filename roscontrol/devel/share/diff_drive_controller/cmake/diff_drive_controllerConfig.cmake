...
if("TRUE" STREQUAL "TRUE")
  set(diff_drive_controller_SOURCE_PREFIX /home/weety/roscontrol/src/ros_controllers/diff_drive_controller)
  set(diff_drive_controller_DEVEL_PREFIX /home/weety/roscontrol/devel)
  ...
  set(diff_drive_controller_INSTALL_PREFIX /home/weety/roscontrol/install)
...
if(NOT "/home/weety/roscontrol/src/ros_controllers/diff_drive_controller/include " STREQUAL " ")
  set(diff_drive_controller_INCLUDE_DIRS "")
  set(_include_dirs "/home/weety/roscontrol/src/ros_controllers/diff_drive_controller/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'diff_drive_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/weety/roscontrol/src/ros_controllers/diff_drive_controller/${idir}'.  Ask the maintainer 'Bence Magyar <bence.magyar.robotics@gmail.com>, Enrique Fernandez <enrique.fernandez.perdomo@gmail.com>' to fix it.")
    endif()
